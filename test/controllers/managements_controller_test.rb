...
class ManagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create management" do
    assert_difference('Management.count') do
      post managements_url, params: { management: { admin: @management.admin, member: @management.member } }
    end
  ...
  test "should update management" do
    patch management_url(@management), params: { management: { admin: @management.admin, member: @management.member } }
